...
EXCLUDE = [
    ...
    'src/secp256k1/src/java/org_straks_NativeSecp256k1.c',
    'src/secp256k1/src/java/org_straks_NativeSecp256k1.h',
    'src/secp256k1/src/java/org_straks_Secp256k1Context.c',
    'src/secp256k1/src/java/org_straks_Secp256k1Context.h',
    # auto generated:
...
Arguments:
    <base_directory> - The base directory of a straks source code repository.
...
Arguments:
    <file> - A source file in the straks repository.
"""
