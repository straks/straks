...
WORKINGDIR="/tmp/straks"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/straks/Straks/straks-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/straks/Straks/"
VERSIONPREFIX="straks-"
RCVERSIONSTRING="rc"
...
if [ $? -ne 0 ]; then
   ...
   echo "[straks-]<version>-[rc[0-9]] (example: straks-0.7.1-rc1)"
   echo "wget output:"
