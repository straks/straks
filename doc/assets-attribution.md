The following is a list of assets used in the straks source and their proper attribution.
...
### Info
* Designer: Jonas Schnelli (based on the original straks logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/straks.icns, src/qt/res/src/straks.svg,
	src/qt/res/src/straks.ico, src/qt/res/src/straks.png,
	src/qt/res/src/straks_testnet.png, docs/straks_logo_doxygen.png,
