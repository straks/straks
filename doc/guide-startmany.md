...
[From the straks github repo](https://github.com/squbs/Straks/blob/master/doc/masternode_conf.md)
...
## What about the straks.conf file?

If you are using a masternode.conf file you no longer need the straks.conf file. The exception is if you need custom settings (thanks oblox). 

## Update straks.conf on server

If you generated a new masternode private key, you will need to update the remote straks.conf files.

Shut down the daemon and then edit the file.

```sudo nano .straks/straks.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the masternodeprivkey value in your remote straks.conf file.
