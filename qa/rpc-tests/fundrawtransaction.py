...
class RawTransactionsTest(StraksTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid straks address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid straks address" in e.error['message'])
