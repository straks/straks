...
unlocked to sign the Straks-Qt.app bundle.
...
allowing somebody to distribute a Straks-Qt.app or straks-qt-setup.exe with a valid
...
that the straks-qt.exe file inside the installer had not been tampered with.
