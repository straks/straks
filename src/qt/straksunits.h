...
#ifndef STRAKS_QT_STRAKSUNITS_H
#define STRAKS_QT_STRAKSUNITS_H
...
/** Straks unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class StraksUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit StraksUnits(QObject *parent);

    /** Straks units.
      @note Source: https://en.straks.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        STAK,
...
typedef StraksUnits::Unit StraksUnit;

#endif // STRAKS_QT_STRAKSUNITS_H
