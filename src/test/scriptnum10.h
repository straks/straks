...
#ifndef STRAKS_TEST_SCRIPTNUM10_H
#define STRAKS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Straks Core 0.10.0, for cross-comparison.
 */
public:
