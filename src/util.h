 ...
 */
#ifndef STRAKS_UTIL_H
#define STRAKS_UTIL_H
...
extern const char * const STRAKS_CONF_FILENAME;
extern const char * const STRAKS_PID_FILENAME;
...
{
    std::string s = strprintf("straks-%s", name);
